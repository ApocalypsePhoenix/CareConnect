...
try {
    if ($worker_id) {
        ...
        $stmt = $db->prepare("SELECT b.*, u.name as client_name, u.phone as client_phone 
                              ...
                              WHERE b.worker_id = :w_id AND b.status IN ('Accepted', 'On_The_Way', 'Arrived', 'In_Progress') LIMIT 1");
        ...
        $stmt = $db->prepare("SELECT b.*, u.name as worker_name, u.phone as worker_phone, u.profile_image as worker_image 
                              ...
                              WHERE b.client_id = :c_id AND b.status IN ('Accepted', 'On_The_Way', 'Arrived', 'In_Progress') LIMIT 1");
